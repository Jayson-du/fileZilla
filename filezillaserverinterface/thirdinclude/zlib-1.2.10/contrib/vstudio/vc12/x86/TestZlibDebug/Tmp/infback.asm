; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.21005.1 
	...
	TITLE	F:\mycode\Hack12306\zlib-1.2.10\infback.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
_DATA	SEGMENT
$SG86021 DB	'invalid distance too far back', 00H
	ORG $+2
$SG85539 DB	'1.2.10', 00H
	ORG $+1
$SG85629 DB	'invalid block type', 00H
	ORG $+1
$SG85656 DB	'invalid stored block lengths', 00H
	ORG $+3
$SG85711 DB	'too many length or distance symbols', 00H
$SG85743 DB	'invalid code lengths set', 00H
	ORG $+3
$SG85791 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG85853 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG85861 DB	'invalid code -- missing end-of-block', 00H
	ORG $+3
$SG85865 DB	'invalid literal/lengths set', 00H
$SG85869 DB	'invalid distances set', 00H
	ORG $+2
$SG85929 DB	'invalid literal/length code', 00H
$SG85994 DB	'invalid distance code', 00H
_DATA	ENDS
...
; File f:\mycode\hack12306\zlib-1.2.10\infback.c
_TEXT	SEGMENT
_state$ = 8						; size = 4
_fixedtables PROC
...
; 38   :         stream_size != (int)(sizeof(z_stream)))
	...
	mov	ecx, 1
	imul	edx, ecx, 0
	movsx	ecx, BYTE PTR $SG85539[edx]
	cmp	eax, ecx
...
; 291  :         switch (state->mode) {
	...
	movzx	edx, BYTE PTR $LN341@inflateBac[ecx]
	jmp	DWORD PTR $LN342@inflateBac[edx*4]
$LN328@inflateBac:
...
; 302  :             switch (BITS(2)) {
	...
	jmp	DWORD PTR $LN343@inflateBac[edx*4]
$LN305@inflateBac:
...
; 320  :                 strm->msg = (char *)"invalid block type";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG85629
...
; 331  :                 strm->msg = (char *)"invalid stored block lengths";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG85656
...
; 369  :                 strm->msg = (char *)"too many length or distance symbols";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG85711
...
; 391  :                 strm->msg = (char *)"invalid code lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG85743
...
; 414  :                             strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG85791
...
; 437  :                         strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG85853
...
; 451  :                 strm->msg = (char *)"invalid code -- missing end-of-block";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG85861
...
; 465  :                 strm->msg = (char *)"invalid literal/lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG85865
...
; 474  :                 strm->msg = (char *)"invalid distances set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG85869
...
; 532  :                 strm->msg = (char *)"invalid literal/length code";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG85929
...
; 564  :                 strm->msg = (char *)"invalid distance code";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG85994
...
; 579  :                 strm->msg = (char *)"invalid distance too far back";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86021
